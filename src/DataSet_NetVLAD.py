...
class TripletNetworkDataset_NetVLAD(Dataset):
    def __init__(self,dataDirectory,file_name, size=None):
        super(TripletNetworkDataset_NetVLAD, self).__init__()
    ...
    def __getitem__(self,index):
        ...
        images = torch.stack((img0,img1,img2),0)
        
        return images, label_1, label_2  #torch.from_numpy(self.label_Data[self.permutated_index[index]], dtype=np.float32)
